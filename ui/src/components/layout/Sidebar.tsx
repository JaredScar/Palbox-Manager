...
const NAV = [
  ...
  { path: '/savebrowser', label: 'Save Browser', accent: '#ffd447', icon: <SaveBrowserIcon />, permission: 'backups.view' },
  ...
  { path: '/events',      label: 'Events',       accent: '#f59e0b', icon: <EventsIcon />,     permission: 'events.view' },
...
function EventsIcon() { return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/><path d="M11 14l2 0-1.5 3.5" strokeLinejoin="round"/></svg>; }
